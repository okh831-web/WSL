  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="relative py-16 overflow-hidden">
        <div className="absolute top-0 left-0 w-1/4 h-full bg-wsl-orange/5 -z-10 hidden lg:block"></div>
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <div className="absolute -top-10 -left-10 w-40 h-40 bg-wsl-orange -z-10 rounded-3xl"></div>
              <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white">
                <img 
                  src="https://picsum.photos/seed/wsl-safety/800/600" 
                  alt="Students in snow" 
                  className="w-full h-auto object-cover"
                  referrerPolicy="no-referrer"
                />
              </div>
              <div className="absolute -bottom-6 -right-6 bg-wsl-orange text-white p-8 rounded-3xl shadow-xl max-w-[240px] text-center transform rotate-3">
            ...
            >
              ...
              <div className="space-y-5">
                {safetyFeatures.map((feature, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center group-hover:bg-wsl-orange/10 transition-colors">
                      {feature.icon}
                    </div>
                    <div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-600 font-medium text-lg leading-relaxed mb-8">
            WSL은 단순한 언어 교육을 넘어, 학생들이 낯선 환경에서도 안심하고 배움에 집중할 수 있도록 
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="bg-white p-10 rounded-[2rem] shadow-sm border border-slate-100">
              <CheckCircle2 className="text-wsl-orange mb-4" size={32} />
